...
# 06/02/2026 - Otimizacao na leitura do banco de geolocalizacao
# 07/02/2026 - Adicionado parse nos dois arquivos de log, versao anterior so analisava ufw.log
# 07/02/2026 - Modificado para gerar CSV e PDF
#
import re
import os
